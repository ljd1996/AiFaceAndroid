...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "HiYkURZ9VNyoZOxhZX6bHTZn";
    public static String secretKey = "oAEBGOqzrxNDrwcYlqXXh7TwvQLqGxpI";
    public static String licenseID = "FaceHearing-face-android";
     ...
     */
    public static String groupID = "hearing1";
